...
#  Created on Wed Jul  8 23:48:00 2026                
#                                                     
#######################################################
...
connet_global_net VDD1v8 -type pg_pin -pin VDD -inst_base_name *
connect_global_net VDD1v8 -type pg_pin -pin VDD -inst_base_name *
connect_global_net VSS -type pg_pin -pin VSS -inst_base_name *
set_db route_special_via_connect_to_shape { noshape }
route_special -connect core_pin -layer_change_range { Metal1(1) Metal11(11) } -block_pin_target nearest_target -core_pin_target first_after_row_end -allow_jogging 1 -crossover_via_layer_range { Metal1(1) Metal11(11) } -nets { VDD1v8 VSS } -allow_layer_change 1 -target_via_layer_range { Metal1(1) Metal11(11) }
set_db place_design_floorplan_mode false
place_design
creat_tree_spec
create_clock_tress_spec
create_clock_tre_spec
...
gui_select -point {8.69350 11.46350}
