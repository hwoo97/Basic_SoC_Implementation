...
# Generated on: Thu Jul 09 02:06:11 KST 2026 (Wed Jul 08 17:06:11 UTC 2026)
...
set logfile fv/updown_counter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/updown_counter -revised fv_map
...
read_library -liberty -both \
    /home/hah015/Basic_SoC_Implementation/3_SYN/5_SYN/2_TINY_PROJECT/1_UP_DOWN_COUNTER/../../../1_LIB/slow_vdd1v0_basicCells.lib
...
add_search_path ../../../../1_RTL/2_TINY_PROJECT/1_UP_DOWN_COUNTER -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../../../1_RTL/2_TINY_PROJECT/1_UP_DOWN_COUNTER/updown_counter.v
elaborate_design -golden -root {updown_counter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/updown_counter/fv_map.v.gz
elaborate_design -revised -root {updown_counter}
...
#add_name_alias fv/updown_counter/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.updown_counter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.updown_counter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.updown_counter.rtl.fv_map.rpt
